...
const PIDGain RPM_M3508 = {3, 0.3, 0.5};
const PIDGain POS_M3508 = {0.03, 0.0, 0.};
const PIDGain RPM_M2006 = {2.5, 0.15, 5};
const PIDGain POS_M2006 = {0.03, 0.0, 0.};
...
void setup() {
  ...
  motor.setRpmPIDgain(1, RPM_M3508);       // 速度制御用PIDゲインを設定する
  motor.setPositionPIDgain(1, POS_M3508);  // 位置制御用PIDゲインを設定する
